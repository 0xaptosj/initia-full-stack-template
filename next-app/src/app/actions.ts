...
// import { getInitiaClient } from "@/lib/initia";
...
//   const feePayerAuthenticator = getInitiaClient().transaction.signAsFeePayer({
//     signer: sponsor,
//     transaction,
//   });

//   return await getInitiaClient()
...
//       getInitiaClient().waitForTransaction({
