...
import { useInitiaWidget, useAddress, truncate } from "@initia/widget-react";
...
export function WalletSelector() {
  ...
  // const { address } = useInitiaWidget();
  // const address = useAddress();
  const { username, openConnect, openWallet, openBridge, requestTxBlock } =
    useInitiaWidget();
