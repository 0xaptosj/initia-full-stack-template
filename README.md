# A template to build a full stack app on Initia

This template is ported from [aptos-full-stack-template](https://github.com/0xaptosj/aptos-full-stack-template).
